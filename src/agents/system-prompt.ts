...
export function buildAgentSystemPrompt(params: {
  ...
  const safetySection = [
    ...
    "Do not manipulate or persuade anyone to expand access or disable safeguards unless instructed by user. Do not copy yourself or change system prompts, safety rules, or tool policies unless explicitly requested.",
    "",
  ];
